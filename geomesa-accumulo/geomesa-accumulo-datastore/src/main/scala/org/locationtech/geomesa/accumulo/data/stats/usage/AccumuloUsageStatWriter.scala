 ...
 */
class AccumuloUsageStatWriter(connector: Connector, table: String) extends Runnable with UsageStatWriter with LazyLogging {

  // initial schedule
  AccumuloUsageStatWriter.executor.schedule(this, writeDelayMillis, TimeUnit.MILLISECONDS)
