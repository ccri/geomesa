...
class KryoFeatureSerializerTest extends Specification with LazyLogging {
  ...
  "KryoFeatureSerializer" should {
    ...
    "read my records" in {
      ...
      // Does not work
      val hex1 = ""
      val bytes1 = org.apache.commons.codec.binary.Hex.decodeHex(hex1.toCharArray)
      val deserialized1 = serializer.deserialize(bytes1)

      // Works
      val hex2 = ""
      val bytes2 = org.apache.commons.codec.binary.Hex.decodeHex(hex2.toCharArray)
...
//      val value: Array[Byte] = readArray(bis)
