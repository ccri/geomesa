...
object SQLSpatialFunctions {
  ...
  def registerFunctions(sqlContext: SQLContext): Unit = {
    ...
    sqlContext.udf.register("st_boundary"      , SQLSpatialAccessorFunctions.ST_Boundary)
    sqlContext.udf.register("st_coordDim"      , SQLSpatialAccessorFunctions.ST_CoordDim)
    sqlContext.udf.register("st_dimension"     , SQLSpatialAccessorFunctions.ST_Dimension)
...
//    sqlContext.udf.register("st_isRing"        , SQLSpatialAccessorFunctions.ST_IsRing)
//    sqlContext.udf.register("st_isSimple"      , SQLSpatialAccessorFunctions.ST_IsSimple)
//    sqlContext.udf.register("st_isValid"       , SQLSpatialAccessorFunctions.ST_IsValid)
//    sqlContext.udf.register("st_numGeometries" , SQLSpatialAccessorFunctions.ST_NumGeometries)
//    sqlContext.udf.register("st_numPoints"     , SQLSpatialAccessorFunctions.ST_NumPoints)
//    sqlContext.udf.register("st_pointN"        , SQLSpatialAccessorFunctions.ST_PointN)
//    sqlContext.udf.register("st_x"             , SQLSpatialAccessorFunctions.ST_X)
//    sqlContext.udf.register("st_y"             , SQLSpatialAccessorFunctions.ST_Y)
